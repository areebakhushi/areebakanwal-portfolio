...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Areeba Kanwal — Flutter Mobile Developer" },
      {
        name: "description",
        content:
          "Portfolio of Areeba Kanwal, Flutter mobile developer building AI-powered apps with Firebase.",
      },
      { name: "author", content: "Areeba Kanwal" },
